...
public class CheckInDemo extends JDialog {
    ...
    public CheckInDemo(WorkFrame bossframe) {
...
//		txtcardid.setColumns(10);
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                CheckInDemo.this.setVisible(false);
    ...
    public static void main(String[] args) {
        ...
        WorkFrame b = new WorkFrame(a);
        CheckInDemo c = new CheckInDemo(b);
        c.setVisible(true);
    }
}
